...
<%
    String wfsql = "SELECT   cba_stg_mst.stg_name, cba_stg_mst2.stg_name, cba_user_mst.full_name,"
            + "         cba_act_mst.act_name, TO_CHAR(cba_tran_wo.act_date, 'DD-MON-YYYY'), cba_tran_wo.cmt,"
            + "         cba_user_mst2.full_name, cba_tran_wo.is_comp"
            + "    FROM cba_act_mst,"
            + "         cba_tran_wo,"
            + "         cba_user_mst,"
            + "         cba_wo_mst,"
            ...
            + "          AND (cba_tran_wo.po_number = '" + request.getParameter("pono") + "')"
            + "         )"
