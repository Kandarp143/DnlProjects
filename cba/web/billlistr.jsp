...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="Right">
                <div>
                      <h4 class="page_title">Bills on Which you took Action</h4>
                </div>
                <%
                    String uid = session.getAttribute("uid").toString();
                    ArrayList<WorkBean> bill = new ArrayList<WorkBean>();
                    BillDao bdao = new BillDao();
                    bill = bdao.getRelatedBillbyUid(uid);
                    if (bill.size() == 0) {
                %>
                ...
                <table class="dtb" id="tab1w" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=wo1.getSTATUS()%></td>
                            <td style="color: #8B0000"><%=wo1.getSTATUS().equalsIgnoreCase("Approved") || wo1.getSTATUS().equalsIgnoreCase("INV Created") ? "-" : wo1.getP_USR_NAME()%></td>
