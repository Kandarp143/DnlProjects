        ...
        <div id="wrapper">
            ...
            <div id="Right">
                ...
                <%
                    ...
                    String suid = uid.substring(1);
                    wo = wdao.getWObySid(suid, true);
                    if (wo.size() == 0) {%>
                ...
                <table class="dtb">
                    ...
                    <tr>
                        ...
                        <%}%>
                        <td><a  style="color: #8B0000;font-weight: bold"href="xls/<%=wo1.getPO_NO().replace("/", "-")%>.xlsx" >Download Excel</a></td>
                    </tr>
                    <%
                        }%>
                </table>
