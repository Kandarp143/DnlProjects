                ...
                <table class="dtb">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form  id="testForm" action="CreateAP?bill=<%=wo1.getBILL_NO()%>&page=a_inv&step=1"
                            ...
                            <form  id="testForm" action="CreateAP?bill=<%=wo1.getBILL_NO()%>&page=a_inv&step=2"
                            ...
                            <form  id="testForm" action="CreateAP?bill=<%=wo1.getBILL_NO()%>&page=a_inv&step=3"
                                   method="post" onsubmit="submit.disabled = true;
                                           submit.value = 'Processing ..';
                                           return true;">
                            ...
                            <form  id="testForm" action="CreateAP?bill=<%=wo1.getBILL_NO()%>&page=a_inv&step=4"
                                   method="post" onsubmit="submit.disabled = true;
                                           submit.value = 'Processing ..';
                                           return true;">
                                <input type="submit" value="Refresh" 
                            ...
                            <form  id="testForm" action="CreateAP?bill=<%=wo1.getBILL_NO()%>&page=a_inv&step=5"
                                   method="post" onsubmit="submit.disabled = true;
                                           submit.value = 'Processing ..';
                                           return true;">
                            ...
                            <form  id="testForm" action="CreateAP?bill=<%=wo1.getBILL_NO()%>&page=a_inv&step=6"
                                   method="post" onsubmit="submit.disabled = true;
                                           submit.value = 'Processing ..';
                                           return true;">
                                <input type="submit" value="Refresh" 
