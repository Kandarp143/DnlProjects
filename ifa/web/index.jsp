...
<%
    ItemDao ddd = new ItemDao();
    GlobalVar.itm_grp = ddd.getItemGrp();%>
<!DOCTYPE html>
<html>
    <head>
            ...
            <tr>
                ...
                <td>
                    <%if (request.getParameterMap().containsKey("act")) {
                            if (request.getParameter("act").equals("done")) {
                                ItemDao d = new ItemDao();
                                GlobalVar.itm_grp = d.getItemGrp();

                    %>
                    <p style="color: green">Requested action done successfully</p>
                    <%}
                        }%>
                </td>
            </tr>
