...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="Right">
                <div>
                    <h4 id="page_header">Save QC</h4>
                </div>
                <div>
                    <form action="process/processQc.jsp?cid=<%=request.getParameter("cid")%>&sid=<%=request.getParameter("sid")%>&act=1" method="post" onsubmit="submit.disabled = true;
                            submit.value = 'Processing ..';
                            return true;">
                        <%
                            GeneralMethods gm = new GeneralMethods();
                            QcDao qcdao = new QcDao();
                            MocQcMst objK = new MocQcMst();
                            objK = qcdao.fecthQc(Integer.parseInt(request.getParameter("cid")));
                            if (objK == null) {%>
                        <%@ include file="include/form/Q1.jsp" %>
                        <%} else {%>
                        <%@ include file="include/update/Q1_U.jsp" %>
                        <%}%>
