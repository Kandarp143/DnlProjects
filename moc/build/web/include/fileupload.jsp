...
<html>
    ...
    <body>
        <h2>Add Attachment for MOC CASE ID  :<%=request.getParameter("cid")%></h2>
        <form method="post" action="../UploadFile" enctype="multipart/form-data" onsubmit="submit.disabled = true;
