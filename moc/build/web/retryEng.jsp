    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="Right">
                ...
                <div>
                    <form action="processEng.jsp?cid=<%=request.getParameter("cid")%>&sid=<%=request.getParameter("sid")%>&act=1" method="post" onsubmit="submit.disabled = true;
                            submit.value = 'Processing ..';
                            return true;">
                        <%@ include file="include/errorlist.jsp" %>
                        <%@ include file="include/retry/E1_R.jsp" %>
